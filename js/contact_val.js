...
function valContactMessage(){
  ...
  const regex = /^[a-zA-Z0-9!#$%&'*+/=?^_`{|}~-]{1,4000}$/;//Declare a regular expression to validate the contact message (UCase and LCase letters, digits and special characters, between 1 and 4000 characters long)
