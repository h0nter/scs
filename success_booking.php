<?php
  ...
  if (!isset($_SESSION['successBooking'])){
    ...
    unset($_SESSION['successBooking']);//Unset the 'successBooking' flag so that the user can't access this page without making a booking again
  }
...
<body>
  ...
  <div id="sign-in-main">
    ...
    <div id="sign-in-form" class="container">
      <div class="heading">
        <h1>Thank you!</h1>
        <h3>Your booking was made successfully</h3>
        <a href="myaccount.php"><h3>You can now manage it on 'My Account' page</h3></a>
      </div>
    </div>
  </div>
